...
import type {} from '@workspacealberta/wa-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@workspacealberta/wa-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@workspacealberta/wa-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@workspacealberta/wa-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@workspacealberta/wa-skill-filesystem"}\n',
