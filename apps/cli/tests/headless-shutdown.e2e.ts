...
import { LOADER_SMOKE_TEST_TIMEOUT_MS, resolveExampleLaunch } from '@workspacealberta/wa-loader-smoke'
...
async function runHeadlessPtySmoke(): Promise<string> {
  ...
  try {
    ...
    await writeFile(join(profileDir, 'package.json'), JSON.stringify({
      ...
      private: true,
      dependencies: {},
      dsh: { profile: { bundles: ['@workspacealberta/wa-base', '@workspacealberta/wa-headless'] } },
    }, undefined, 2))
