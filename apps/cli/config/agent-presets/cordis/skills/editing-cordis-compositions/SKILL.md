...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@workspacealberta/wa-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@workspacealberta/wa-tool-workflow'
```
