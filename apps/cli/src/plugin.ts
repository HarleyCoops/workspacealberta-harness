/**
 * `wa plugin --profile <name> <args...>` — profile plugin management as a
 ...
 * @module @workspacealberta/wa/plugin
 */
...
/**
 * Run one `wa plugin` invocation: init if needed, forward to pnpm, reconcile.
