...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@workspacealberta/wa-my-cap'
...
```yaml
- name: '@workspacealberta/wa-my-cap-local'
- name: '@workspacealberta/wa-tool-my-cap'
```
