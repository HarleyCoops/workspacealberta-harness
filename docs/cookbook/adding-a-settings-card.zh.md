...
import type {} from '@workspacealberta/wa-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@workspacealberta/wa-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@workspacealberta/wa-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
