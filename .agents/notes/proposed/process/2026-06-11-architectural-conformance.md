...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@workspacealberta/wa-agent-loop`.
- No cross-package deep imports (`@workspacealberta/wa-*/src/...` paths) — public entry points only.
