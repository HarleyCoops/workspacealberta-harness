 ...
 * @module @workspacealberta/wa-cordis-host-runner/guard
 */

import { Context } from '@workspacealberta/cordis'
import type { Plugin } from '@workspacealberta/cordis'
import { scopeOf } from '@workspacealberta/wa-scope'
import { assertSupportedJsonSchema, defineTool } from '@workspacealberta/wa-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@workspacealberta/wa-cordis-client-runner`, whose CTX_VERBS names this one its
