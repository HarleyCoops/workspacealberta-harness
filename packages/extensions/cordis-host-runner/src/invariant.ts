/**
 * Package-owned invariant companion for `@workspacealberta/wa-cordis-host-runner`.
 * @module @workspacealberta/wa-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-cordis-host-runner'
