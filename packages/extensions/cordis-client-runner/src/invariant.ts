/**
 * Package-owned invariant companion for `@workspacealberta/wa-cordis-client-runner`.
 * @module @workspacealberta/wa-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-cordis-client-runner'
