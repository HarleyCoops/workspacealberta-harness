 ...
 * @module @workspacealberta/wa-tool-cordis
 */
...
} from '@workspacealberta/wa-cordis-host-runner'
import type { DynamicCordisReference } from '@workspacealberta/wa-cordis-host-runner'
