/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-cordis`.
 * @module @workspacealberta/wa-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-cordis'
