/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-cordis`.
 * @module @workspacealberta/wa-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-cordis'
