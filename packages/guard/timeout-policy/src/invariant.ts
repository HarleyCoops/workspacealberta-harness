/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-call-timeout-policy`.
 * @module @workspacealberta/wa-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-call-timeout-policy'
