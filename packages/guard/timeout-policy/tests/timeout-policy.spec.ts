/**
 * Unit + real-load-path coverage for @workspacealberta/wa-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@workspacealberta/wa-llm'
import SystemPrompt from '@workspacealberta/wa-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@workspacealberta/wa-tools'
import * as timeoutPolicy from '@workspacealberta/wa-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@workspacealberta/wa-tool-call-timeout-policy'
