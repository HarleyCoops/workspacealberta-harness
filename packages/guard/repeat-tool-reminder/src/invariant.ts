/**
 * Package-owned invariant companion for `@workspacealberta/wa-repeat-tool-reminder`.
 * @module @workspacealberta/wa-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-repeat-tool-reminder'
