...
import { Session, SessionId, canonicalHeader, foldRequestHeader, headerEquals } from '@workspacealberta/wa-session'
import type { EpochHeader, SessionEvent } from '@workspacealberta/wa-session'
