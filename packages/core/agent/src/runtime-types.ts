 ...
 * turn/step boundaries remain `@workspacealberta/wa-session` events.
 *
 * @module @workspacealberta/wa-agent
 */

import type { Context } from '@workspacealberta/cordis'
import type { Scoped } from '@workspacealberta/wa-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@workspacealberta/wa-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@workspacealberta/wa-session'
export type { AgentCancelCause } from '@workspacealberta/wa-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@workspacealberta/wa-system-prompt'
declare module '@workspacealberta/wa-system-prompt' {
...
declare module '@workspacealberta/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@workspacealberta/wa-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
