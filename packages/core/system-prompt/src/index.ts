 ...
 *
 * @module @workspacealberta/wa-system-prompt
 */

import { Context, Service } from '@workspacealberta/cordis'
import z from '@workspacealberta/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@workspacealberta/wa-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@workspacealberta/wa-scope'
import type { ContextSnapshotSection, ToolSchema } from '@workspacealberta/wa-llm'
...
declare module '@workspacealberta/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@workspacealberta/wa-scope`): scoped listeners
