...
import { createScope, scopeOf } from '@workspacealberta/wa-scope'
import type { Scope, ScopeKey } from '@workspacealberta/wa-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@workspacealberta/wa-system-prompt'
import type { Config, PromptAssembly } from '@workspacealberta/wa-system-prompt'
