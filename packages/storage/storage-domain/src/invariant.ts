/**
 * Package-owned invariant companion for `@workspacealberta/wa-storage-domain`: every
 ...
 * @module @workspacealberta/wa-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-storage-domain'
