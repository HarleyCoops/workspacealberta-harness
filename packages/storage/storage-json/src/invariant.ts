/**
 * Package-owned invariant companion for `@workspacealberta/wa-storage-json`.
 * @module @workspacealberta/wa-storage-json/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-storage-json'
