/**
 * Package-owned invariant companion for `@workspacealberta/wa-storage`.
 * @module @workspacealberta/wa-storage/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-storage'
