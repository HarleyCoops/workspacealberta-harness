/**
 * Package-owned invariant companion for `@workspacealberta/wa-storage-sqlite`.
 * @module @workspacealberta/wa-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-storage-sqlite'
