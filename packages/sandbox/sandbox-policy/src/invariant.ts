/** Package-owned session-event invariants for sandbox policy. @module @workspacealberta/wa-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@workspacealberta/wa-sandbox-policy'
