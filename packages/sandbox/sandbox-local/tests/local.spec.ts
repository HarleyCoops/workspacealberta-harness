...
import { LAUNCHER_FAILURE_EXIT } from '@workspacealberta/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@workspacealberta/wa-sandbox'
import type { SandboxPolicy } from '@workspacealberta/wa-sandbox'
import {
  LocalSandboxProvider,
} from '@workspacealberta/wa-sandbox-local'
import type { Config } from '@workspacealberta/wa-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @workspacealberta/wa-sandbox-windows-acl/tests/provider-chain.spec.ts
