...
const platformPackageName = `@workspacealberta/node-addon-landlock-run-linux-${process.arch}`
...
const WORKSPACE_CLOSURE = [
  ...
  // consumer resolves it like any other @workspacealberta peer (koffi arrives
  // from the registry).
