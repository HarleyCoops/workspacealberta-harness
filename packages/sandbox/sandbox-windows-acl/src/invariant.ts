/**
 * Package-owned invariant companion for `@workspacealberta/wa-sandbox-windows-acl`.
 * @module @workspacealberta/wa-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-sandbox-windows-acl'
