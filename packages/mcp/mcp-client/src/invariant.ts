/**
 * Package-owned invariant companion for `@workspacealberta/wa-mcp-client`.
 * @module @workspacealberta/wa-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-mcp-client'
