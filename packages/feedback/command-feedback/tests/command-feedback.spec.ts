...
import SessionStore, { foldSurface, Session, SessionId } from '@workspacealberta/wa-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@workspacealberta/wa-session-telemetry'
import * as commandFeedback from '@workspacealberta/wa-command-feedback'
...
vi.mock('@workspacealberta/wa-anonymous-user-id', () => ({
...
describe('@workspacealberta/wa-command-feedback registration', () => {
