/**
 * Package-owned invariant companion for `@workspacealberta/wa-command-feedback`.
 * @module @workspacealberta/wa-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-command-feedback'
