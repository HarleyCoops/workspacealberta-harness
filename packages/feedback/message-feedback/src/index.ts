 ...
 * @module @workspacealberta/wa-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@workspacealberta/cordis'
import s from '@workspacealberta/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@workspacealberta/wa-session/surface'
import type { SessionHeader, SessionId } from '@workspacealberta/wa-session/types'
