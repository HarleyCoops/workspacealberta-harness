/**
 * Package-owned invariant companion for `@workspacealberta/wa-typert-registry`.
 * @module @workspacealberta/wa-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-typert-registry'
