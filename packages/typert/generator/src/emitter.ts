 ...
 * @module @workspacealberta/wa-typert-generator/emitter
 */
...
export class FaceModelEmitter {
  ...
  private renderJs(
    ...
    const lines = [
      '/* Generated by @workspacealberta/wa-typert-generator from FaceModel — do not edit. */',
    ]
  ...
  private emitRemote(packageModel: PackageModel): RemoteModelEmitResult {
    ...
    const lines = [
      '/* Generated by @workspacealberta/wa-typert-generator from the Host FaceModel — do not edit. */',
    ]
    if (schemas.definitions.length > 0) lines.push('import { z } from \'zod\'', '')
    lines.push(...schemas.definitions)
    if (schemas.definitions.length > 0) lines.push('')
  ...
  private renderRemoteDts(packageModel: PackageModel): Pick<RemoteModelEmitResult, 'dts' | 'dtsMap'> {
    ...
    lines.push('')
    lines.push('declare module \'@workspacealberta/wa-typert-protocol\' {')
