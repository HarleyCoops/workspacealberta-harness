/**
 * Package-owned invariant companion for `@workspacealberta/wa-typert-generator`.
 * @module @workspacealberta/wa-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-typert-generator'
