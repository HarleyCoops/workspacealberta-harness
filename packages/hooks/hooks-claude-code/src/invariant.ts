/**
 * Package-owned invariant companion for `@workspacealberta/wa-hooks-claude-code`.
 * @module @workspacealberta/wa-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-hooks-claude-code'
