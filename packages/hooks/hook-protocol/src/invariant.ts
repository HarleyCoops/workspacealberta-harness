/** Package-owned hook invocation/result stream invariants. @module @workspacealberta/wa-hook-protocol/invariant */
...
const PACKAGE_NAME = '@workspacealberta/wa-hook-protocol'
