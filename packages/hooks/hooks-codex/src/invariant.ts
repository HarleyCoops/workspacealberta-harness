/**
 * Package-owned invariant companion for `@workspacealberta/wa-hooks-codex`.
 * @module @workspacealberta/wa-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-hooks-codex'
