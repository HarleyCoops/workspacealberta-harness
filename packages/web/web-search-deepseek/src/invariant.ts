/**
 * Package-owned invariant companion for `@workspacealberta/wa-web-search-deepseek`.
 * @module @workspacealberta/wa-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-web-search-deepseek'
