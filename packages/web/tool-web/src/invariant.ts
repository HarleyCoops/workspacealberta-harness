/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-web`.
 * @module @workspacealberta/wa-tool-web/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-web'
