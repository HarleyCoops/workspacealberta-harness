/**
 * `@workspacealberta/wa-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@workspacealberta/wa-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@workspacealberta/wa-web`.
 *
