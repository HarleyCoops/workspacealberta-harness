 ...
 * `@workspacealberta/wa-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @workspacealberta/wa-web-fetch-http/provider
 */

import { WebError } from '@workspacealberta/wa-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@workspacealberta/wa-web'
