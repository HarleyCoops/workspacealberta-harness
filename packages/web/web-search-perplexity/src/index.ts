/**
 * `@workspacealberta/wa-web-search-perplexity`: registers a Perplexity-backed
 * `WebSearchProvider` with `ctx.web`. A function/namespace plugin (NOT a
 * default-export service): it registers INTO the seam's provider registry, like
 * `@workspacealberta/wa-llm-deepseek` registers an adapter into `ctx.llm`.
 *
 * @module @workspacealberta/wa-web-search-perplexity
 */
