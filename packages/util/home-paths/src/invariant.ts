/**
 * Package-owned invariant companion for `@workspacealberta/wa-home-paths`.
 * @module @workspacealberta/wa-home-paths/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-home-paths'
