/**
 * Package-owned invariant companion for `@workspacealberta/wa-output-retention`.
 * @module @workspacealberta/wa-output-retention/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-output-retention'
