/**
 * Package-owned invariant companion for `@workspacealberta/wa-timeout`.
 * @module @workspacealberta/wa-timeout/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-timeout'
