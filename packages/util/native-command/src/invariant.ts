/**
 * Package-owned invariant companion for `@workspacealberta/wa-native-command`.
 * @module @workspacealberta/wa-native-command/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-native-command'
