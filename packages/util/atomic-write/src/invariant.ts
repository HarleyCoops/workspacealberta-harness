/**
 * Package-owned invariant companion for `@workspacealberta/wa-atomic-write`.
 * @module @workspacealberta/wa-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-atomic-write'
