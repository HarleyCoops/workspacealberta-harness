...
import type { Config } from '@workspacealberta/wa-terminal-bash/src/config.ts'
import { resolveConfig, validateConfig } from '@workspacealberta/wa-terminal-bash/src/config.ts'
