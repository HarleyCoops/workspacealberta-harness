/**
 * Package-owned invariant companion for `@workspacealberta/wa-terminal-bash`.
 * @module @workspacealberta/wa-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-terminal-bash'
