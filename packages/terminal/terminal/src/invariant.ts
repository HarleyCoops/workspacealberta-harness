/**
 * Package-owned invariant companion for `@workspacealberta/wa-terminal`.
 * @module @workspacealberta/wa-terminal/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-terminal'
