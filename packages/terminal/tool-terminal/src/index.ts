 ...
 * @module @workspacealberta/wa-tool-terminal
 */
...
import { TerminalSessionId } from '@workspacealberta/wa-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@workspacealberta/wa-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @workspacealberta/wa-jobs and @workspacealberta/wa-tool-jobs')
