/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-terminal`.
 * @module @workspacealberta/wa-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-terminal'
