/**
 * Package-owned invariant companion for `@workspacealberta/wa-subprocess-e2b`.
 * @module @workspacealberta/wa-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-subprocess-e2b'
