/** Package-owned compaction log-stream invariants. @module @workspacealberta/wa-compaction/invariant */

import type { Context } from '@workspacealberta/cordis'
import { isReplacementSurfaceEvent } from '@workspacealberta/wa-session'
...
const PACKAGE_NAME = '@workspacealberta/wa-compaction'
