 ...
 *
 * The seam itself lives in `@workspacealberta/wa-compaction`, which re-exports these
 ...
 *
 * @module @workspacealberta/wa-compaction/checkpoint
 */

import type { MessageSource } from '@workspacealberta/wa-llm/message'
