/**
 * Package-owned invariant companion for `@workspacealberta/wa-command-compact`.
 * @module @workspacealberta/wa-command-compact/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-command-compact'
