...
import * as invariant from '@workspacealberta/wa-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@workspacealberta/wa-command-compact', expect.any(Function))
    expect(() => {
