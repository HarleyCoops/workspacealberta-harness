...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@workspacealberta/wa-token-meter', TokenMeter],
    ['@workspacealberta/wa-compaction-tool-result-pruner', ToolResultPruner],
    ['@workspacealberta/wa-compaction-basic', BasicCompactionEngine],
  ])
