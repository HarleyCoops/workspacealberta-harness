 ...
 *
 * @module @workspacealberta/wa-compaction-tool-result-pruner
 */

import { Context, Service } from '@workspacealberta/cordis'
import z from '@workspacealberta/schemastery'
import { freezeMessage } from '@workspacealberta/wa-llm'
import type { ContentBlock } from '@workspacealberta/wa-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@workspacealberta/wa-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@workspacealberta/wa-compaction'
