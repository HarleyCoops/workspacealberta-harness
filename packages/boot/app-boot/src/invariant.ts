/**
 * Package-owned invariant companion for `@workspacealberta/wa-app-boot`.
 * @module @workspacealberta/wa-app-boot/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-app-boot'
