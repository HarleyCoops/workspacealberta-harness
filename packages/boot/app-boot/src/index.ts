 ...
 * @module @workspacealberta/wa-app-boot
 */
...
import { Context, type FiberState } from '@workspacealberta/cordis'
import Loader, { type Entry, type EntryOptions } from '@workspacealberta/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@workspacealberta/cordis-plugin-include'
import Group from '@workspacealberta/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@workspacealberta/wa-home-paths'
 ...
 * entries (`@workspacealberta/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@workspacealberta/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@workspacealberta/cordis-plugin-group`
