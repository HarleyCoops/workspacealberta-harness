/**
 * Package-owned invariant companion for `@workspacealberta/wa-cmdline`.
 * @module @workspacealberta/wa-cmdline/invariant
 */

import type { Context } from '@workspacealberta/cordis'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-cmdline'
