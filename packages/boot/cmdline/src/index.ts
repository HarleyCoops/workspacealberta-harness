/**
 * @workspacealberta/wa-cmdline — the command line a dsh launcher hands to the app
 * it boots.
 *
 ...
 * @module @workspacealberta/wa-cmdline
 */
 ...
 * verbatim and in argv order. `wa --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
