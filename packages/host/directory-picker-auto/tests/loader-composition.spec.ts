...
import HttpServer from '@workspacealberta/wa-host-webserver'
import type { DirectoryPicker } from '@workspacealberta/wa-host-directory-picker'
import BrowseDirectoryPicker from '@workspacealberta/wa-host-directory-picker-browse'
import NativeDirectoryPicker from '@workspacealberta/wa-host-directory-picker-native'
...
const AUTO = '@workspacealberta/wa-host-directory-picker-auto'
const NATIVE = '@workspacealberta/wa-host-directory-picker-native'
const BROWSE = '@workspacealberta/wa-host-directory-picker-browse'
const NATIVE_SURFACE = '@workspacealberta/wa-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@workspacealberta/wa-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@workspacealberta/wa-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@workspacealberta/wa-host-webserver', HttpServer],
