 ...
 * @module @workspacealberta/wa-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@workspacealberta/wa-host-directory-picker-native',
  browse: '@workspacealberta/wa-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@workspacealberta/wa-client-ui-directory-picker-native',
  browse: '@workspacealberta/wa-client-ui-directory-picker-browse',
}
