/** Package-owned invariant companion for the directory-picker seam. @module @workspacealberta/wa-host-directory-picker/invariant */

import type { Context } from '@workspacealberta/cordis'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-host-directory-picker'
