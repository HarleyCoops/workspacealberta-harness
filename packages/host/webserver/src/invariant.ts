/**
 * Package-owned invariant companion for `@workspacealberta/wa-host-webserver`.
 * @module @workspacealberta/wa-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-host-webserver'
