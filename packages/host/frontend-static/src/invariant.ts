/**
 * Package-owned invariant companion for `@workspacealberta/wa-host-frontend-static`.
 * @module @workspacealberta/wa-host-frontend-static/invariant
 */

import type { Context } from '@workspacealberta/cordis'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-host-frontend-static'
