...
import type { Agent, AgentFactory } from '@workspacealberta/wa-agent'
...
import type { DirectoryPickerCapability } from '@workspacealberta/wa-host-directory-picker'
import WorkspaceRegistry from '@workspacealberta/wa-workspace'
import type { HostFrame, WorkspaceId } from '@workspacealberta/wa-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@workspacealberta/wa-host-apiproxy/api/rpc'
