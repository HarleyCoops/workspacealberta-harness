/**
 * Package-owned invariant companion for `@workspacealberta/wa-host-apiproxy`.
 * @module @workspacealberta/wa-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-host-apiproxy'
