...
import type { AskUserQuestionItem } from '@workspacealberta/wa-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@workspacealberta/wa-user-approval/types'
import type { Message } from '@workspacealberta/wa-llm/types'
import type { MessageId } from '@workspacealberta/wa-llm/brand'
import type { CallId } from '@workspacealberta/wa-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@workspacealberta/wa-session/types'
import type { ToolCallView, ToolResultView } from '@workspacealberta/wa-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@workspacealberta/wa-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
