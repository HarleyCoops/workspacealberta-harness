/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-pwsh-persistent`.
 * @module @workspacealberta/wa-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-pwsh-persistent'
