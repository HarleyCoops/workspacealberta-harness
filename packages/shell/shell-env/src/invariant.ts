/**
 * Package-owned invariant companion for `@workspacealberta/wa-shell-env`.
 * @module @workspacealberta/wa-shell-env/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-shell-env'
