/**
 * Package-owned invariant companion for `@workspacealberta/wa-pwsh-sandbox`.
 * @module @workspacealberta/wa-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-pwsh-sandbox'
