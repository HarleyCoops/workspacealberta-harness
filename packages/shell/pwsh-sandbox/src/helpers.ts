 ...
 * mirror of `@workspacealberta/wa-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @workspacealberta/wa-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@workspacealberta/wa-shell'
import type { RunnerFailureRule } from '@workspacealberta/wa-sandbox'
