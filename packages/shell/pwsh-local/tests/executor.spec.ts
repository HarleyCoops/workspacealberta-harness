/**
 * Real-process tests for `@workspacealberta/wa-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@workspacealberta/wa-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@workspacealberta/wa-subprocess'
import { MAX_TIMER_DELAY_MS } from '@workspacealberta/wa-timeout'
import type { ShellProcess } from '@workspacealberta/wa-shell'
