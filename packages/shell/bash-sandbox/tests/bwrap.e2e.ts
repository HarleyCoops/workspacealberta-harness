...
import { bwrapProfileArgs } from '@workspacealberta/wa-sandbox-local/src/profiles.ts'
 ...
 * backend-only confinement is covered by `@workspacealberta/wa-sandbox-local`.
 *
