...
import { seatbeltProfileArgs } from '@workspacealberta/wa-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@workspacealberta/wa-sandbox-local`. Skips off macOS or when
