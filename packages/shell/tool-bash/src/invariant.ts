/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-bash`.
 * @module @workspacealberta/wa-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-bash'
