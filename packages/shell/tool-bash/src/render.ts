 ...
 *
 * @module @workspacealberta/wa-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@workspacealberta/wa-shell'
import type { SandboxMode } from '@workspacealberta/wa-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@workspacealberta/wa-sandbox'
 ...
 * rendering story, owned by `@workspacealberta/wa-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@workspacealberta/wa-shell'
