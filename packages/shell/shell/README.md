...
| Package | Role |
|---|---|
| `@workspacealberta/wa-shell` (this) | Service Definition: abstract service + vocabulary types |
| `@workspacealberta/wa-bash-local` | Service Provider: local subprocesses |
| `@workspacealberta/wa-bash-sandbox` | Service Provider: `dsh-bash-local`'s mechanics with every spawn confined via [`ctx.sandbox`](../../sandbox/sandbox/), denials reported as result facts |
| `@workspacealberta/wa-tool-bash` | the model-facing tool schemas over `ctx.shell` |
