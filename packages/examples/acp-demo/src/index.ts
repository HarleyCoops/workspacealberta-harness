 ...
 * ({@link @workspacealberta/wa-agent-spine-demo}), JSONL session persistence, and
 * the {@link @workspacealberta/wa-acp} bridge. The app owns those plugins through one
 ...
 * @module @workspacealberta/wa-acp-demo
 */

import type { Context } from '@workspacealberta/cordis'
import { join } from 'node:path'
import z from '@workspacealberta/schemastery'
import * as acp from '@workspacealberta/wa-acp'
import * as agentCore from '@workspacealberta/wa-agent-spine-demo'
...
} from '@workspacealberta/wa-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@workspacealberta/wa-session-checkpoint-policy'
