/**
 * Package-owned invariant companion for `@workspacealberta/wa-acp-demo`.
 * @module @workspacealberta/wa-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-acp-demo'
