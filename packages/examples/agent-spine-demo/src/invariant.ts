/**
 * Package-owned invariant companion for `@workspacealberta/wa-agent-spine-demo`.
 * @module @workspacealberta/wa-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-agent-spine-demo'
