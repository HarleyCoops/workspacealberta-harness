/**
 * Package-owned invariant companion for `@workspacealberta/wa-sdk-jsonrpc-demo`.
 * @module @workspacealberta/wa-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-sdk-jsonrpc-demo'
