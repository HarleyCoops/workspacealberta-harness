 ...
 */
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@workspacealberta/wa-client-ui-slots'
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry) into every
// program that sees this contract, so PropsRuntime<'sidebar'> resolves.
import type {} from '@workspacealberta/wa-client-ui-layout/client'
import type { WorkspaceId } from '@workspacealberta/wa-client-runtime/client'
