/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-sidebar`.
 * @module @workspacealberta/wa-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-sidebar'
