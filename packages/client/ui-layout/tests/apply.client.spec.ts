...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@workspacealberta/wa-client-ui-theme/client'
import { apply, inject, LayoutController } from '@workspacealberta/wa-client-ui-layout/client'
import { apply as nodeApply } from '@workspacealberta/wa-client-ui-layout'
import * as invariant from '@workspacealberta/wa-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@workspacealberta/wa-client-ui-layout', expect.any(Function))
