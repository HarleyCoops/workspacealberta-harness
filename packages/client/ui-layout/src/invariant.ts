/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-layout`.
 * @module @workspacealberta/wa-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-layout'
