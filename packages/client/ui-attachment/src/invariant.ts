/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-attachment`.
 * @module @workspacealberta/wa-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-attachment'
