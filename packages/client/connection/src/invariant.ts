/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-connection`.
 * @module @workspacealberta/wa-client-connection/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-connection'
