/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-trajectory`.
 * @module @workspacealberta/wa-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-trajectory'
