 ...
 * not built (`pnpm --filter @workspacealberta/wa-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@workspacealberta/wa-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@workspacealberta/wa-client-runtime/client', await import('@workspacealberta/wa-client-runtime/client')],
      ['@workspacealberta/wa-client-ui-primitives', await import('@workspacealberta/wa-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@workspacealberta/wa-client-locale/client')
