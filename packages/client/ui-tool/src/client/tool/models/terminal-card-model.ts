 ...
 * @module
 */
import { resolveWorkspacePath } from '@workspacealberta/wa-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@workspacealberta/wa-client-ui-primitives'
