 ...
 * ({@link module:@workspacealberta/wa-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@workspacealberta/wa-client-ui-primitives'
