/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-tool`.
 * @module @workspacealberta/wa-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-tool'
