...
import type { ToolResultView } from '@workspacealberta/wa-api-remotes/client'
import { bindSnapshotSelector } from '@workspacealberta/wa-client-test-runtime'
import type { SelectionTarget } from '@workspacealberta/wa-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@workspacealberta/wa-client-ui-tool/client'
import { IconGlobeOutline14 } from '@workspacealberta/wa-client-ui-primitives'
import { webCardModel } from '../src/client/tool/models/web-card-model.ts'
import { createChatStore } from '@workspacealberta/wa-client-ui-conversation/src/client/stores.ts'
import { GenericToolCard } from '../src/client/tool/toolviews/GenericToolCard.tsx'
import { DetailsPanel } from '@workspacealberta/wa-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
import { zh } from '@workspacealberta/wa-client-ui-conversation/src/client/locales.ts'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@workspacealberta/cordis').Context
