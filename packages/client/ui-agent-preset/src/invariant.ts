/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-agent-preset`.
 * @module @workspacealberta/wa-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-agent-preset'
