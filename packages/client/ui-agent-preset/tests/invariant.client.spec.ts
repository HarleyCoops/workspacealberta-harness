...
import * as AgentPresetInvariant from '@workspacealberta/wa-client-ui-agent-preset/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@workspacealberta/wa-client-ui-agent-preset')
