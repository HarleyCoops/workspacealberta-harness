/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-settings-models`.
 * @module @workspacealberta/wa-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-settings-models'
