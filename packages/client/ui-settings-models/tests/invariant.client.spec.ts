...
import * as ModelsInvariant from '@workspacealberta/wa-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@workspacealberta/wa-client-ui-settings-models')
    apply()
