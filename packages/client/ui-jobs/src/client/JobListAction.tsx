...
import type { JobView } from '@workspacealberta/wa-client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@workspacealberta/wa-client-ui-primitives'
