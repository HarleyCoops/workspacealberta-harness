/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-jobs`.
 * @module @workspacealberta/wa-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-jobs'
