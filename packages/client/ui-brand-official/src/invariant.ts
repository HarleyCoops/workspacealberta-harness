/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-brand-official`.
 * @module @workspacealberta/wa-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-brand-official'
