/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-model-selection`.
 * @module @workspacealberta/wa-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-model-selection'
