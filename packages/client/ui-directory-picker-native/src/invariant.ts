/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-directory-picker-native`.
 * @module @workspacealberta/wa-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-directory-picker-native'
