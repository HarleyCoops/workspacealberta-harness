/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-runtime`.
 * @module @workspacealberta/wa-client-runtime/invariant
 */
...
import type { SlotMap } from '@workspacealberta/wa-client-ui-slots'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-client-runtime'
