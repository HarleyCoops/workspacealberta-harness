/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-plan`.
 * @module @workspacealberta/wa-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-plan'
