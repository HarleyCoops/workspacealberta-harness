/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-primitives`.
 * @module @workspacealberta/wa-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-primitives'
