...
import { createScope, scopeOf, SlotRegistry } from '@workspacealberta/wa-client-runtime/client'
import type { SessionId } from '@workspacealberta/wa-client-runtime/client'
import { apply, inject, InputTriggerService } from '@workspacealberta/wa-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@workspacealberta/wa-client-ui-input-trigger/client'
