/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-input-trigger`.
 * @module @workspacealberta/wa-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-input-trigger'
