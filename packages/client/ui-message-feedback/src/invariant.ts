/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-message-feedback`.
 * @module @workspacealberta/wa-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-message-feedback'
