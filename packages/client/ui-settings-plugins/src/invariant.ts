/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-settings-plugins`.
 * @module @workspacealberta/wa-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-settings-plugins'
