/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-theme`.
 * @module @workspacealberta/wa-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-theme'
