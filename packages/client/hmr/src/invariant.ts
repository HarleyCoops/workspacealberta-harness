/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-hmr`.
 * @module @workspacealberta/wa-client-hmr/invariant
 */

import type { Context, Fiber } from '@workspacealberta/cordis'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-client-hmr'
