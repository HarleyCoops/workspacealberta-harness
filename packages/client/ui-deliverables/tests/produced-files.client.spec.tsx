...
import type { ChatFileMentions, TurnTailOwnerProps } from '@workspacealberta/wa-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@workspacealberta/wa-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@workspacealberta/wa-client-ui-deliverables'])
