/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-deliverables`.
 * @module @workspacealberta/wa-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-deliverables'
