/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-skill`.
 * @module @workspacealberta/wa-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-skill'
