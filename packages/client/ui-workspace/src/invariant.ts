/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-workspace`.
 * @module @workspacealberta/wa-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-workspace'
