/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-settings-general`.
 * @module @workspacealberta/wa-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-settings-general'
