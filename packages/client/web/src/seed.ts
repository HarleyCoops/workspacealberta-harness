...
import * as Cordis from '@workspacealberta/cordis'
import * as UiSlots from '@workspacealberta/wa-client-ui-slots'
import * as UiPrimitives from '@workspacealberta/wa-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@workspacealberta/cordis': Cordis,
    '@workspacealberta/wa-client-ui-slots': UiSlots,
    '@workspacealberta/wa-client-ui-primitives': UiPrimitives,
