/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-web`.
 * @module @workspacealberta/wa-client-web/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-web'
