...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@workspacealberta/wa-client-hmr`); the loader only inventories owned style tag ids per record.
