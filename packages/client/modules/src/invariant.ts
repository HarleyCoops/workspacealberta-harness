/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-modules`.
 * @module @workspacealberta/wa-client-modules/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-modules'
