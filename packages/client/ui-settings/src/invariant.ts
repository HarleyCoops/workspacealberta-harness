/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-settings`.
 * @module @workspacealberta/wa-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-settings'
