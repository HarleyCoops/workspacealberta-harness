/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-renderer`.
 * @module @workspacealberta/wa-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-renderer'
