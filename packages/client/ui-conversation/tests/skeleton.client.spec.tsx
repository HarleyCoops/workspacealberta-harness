...
import type { ClientContext } from '@workspacealberta/wa-client-runtime/client'
import { makeTranslate } from '@workspacealberta/wa-client-test-runtime'
import { en as commonEn } from '@workspacealberta/wa-client-locale/src/locales/en.ts'
...
describe('Hero chrome', () => {
  it('renders the English preview badge through the hero locale seat', () => {
    ...
    expect(view.getByText('Welcome to workspaceAlberta')).toBeTruthy()
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText('欢迎使用 workspaceAlberta')).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText('欢迎使用 workspaceAlberta')).toBeNull()
  })
