...
import type {} from '@workspacealberta/wa-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@workspacealberta/wa-goal/client'
...
import type { Translate } from '@workspacealberta/wa-client-ui-slots'
