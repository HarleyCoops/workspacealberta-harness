/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-conversation`.
 * @module @workspacealberta/wa-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-conversation'
