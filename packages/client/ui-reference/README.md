# `@workspacealberta/wa-client-ui-reference`
...
Indirectly, through `@workspacealberta/wa-file-reference-local` for path guidance and `@workspacealberta/wa-session-reference` for prepared session snapshots.
