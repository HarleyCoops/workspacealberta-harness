/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-reference`.
 * @module @workspacealberta/wa-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-reference'
