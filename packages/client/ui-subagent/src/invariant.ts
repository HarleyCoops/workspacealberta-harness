/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-subagent`.
 * @module @workspacealberta/wa-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-subagent'
