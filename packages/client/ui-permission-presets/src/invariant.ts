/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-permission-presets`.
 * @module @workspacealberta/wa-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-permission-presets'
