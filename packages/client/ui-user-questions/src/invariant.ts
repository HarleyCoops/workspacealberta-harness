/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-user-questions`.
 * @module @workspacealberta/wa-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-user-questions'
