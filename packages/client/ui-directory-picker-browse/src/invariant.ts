/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-directory-picker-browse`.
 * @module @workspacealberta/wa-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-directory-picker-browse'
