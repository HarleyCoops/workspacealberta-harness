/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-goal`.
 * @module @workspacealberta/wa-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-goal'
