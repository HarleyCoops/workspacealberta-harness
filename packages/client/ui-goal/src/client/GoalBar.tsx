...
import type { GoalSnapshot } from '@workspacealberta/wa-goal/client'
import {
...
export type GoalDockProps = import('@workspacealberta/wa-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
