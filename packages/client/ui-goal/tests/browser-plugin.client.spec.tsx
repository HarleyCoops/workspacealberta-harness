...
import { SlotRegistry, type SessionId } from '@workspacealberta/wa-client-runtime/client'
import { ConversationEventRegistry } from '@workspacealberta/wa-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@workspacealberta/wa-goal/client'
