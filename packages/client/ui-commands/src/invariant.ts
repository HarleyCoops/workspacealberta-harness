/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-commands`.
 * @module @workspacealberta/wa-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-commands'
