/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-locale`.
 * @module @workspacealberta/wa-client-locale/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-locale'
