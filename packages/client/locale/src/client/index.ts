...
import type { ClientContext, SettingsScope } from '@workspacealberta/wa-client-runtime/client'
...
export type { Translate, TranslateNS } from '@workspacealberta/wa-client-ui-slots'
