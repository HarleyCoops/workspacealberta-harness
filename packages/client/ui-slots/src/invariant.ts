/**
 * Package-owned invariant companion for `@workspacealberta/wa-client-ui-slots`.
 * @module @workspacealberta/wa-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-client-ui-slots'
