/**
 * Package-owned invariant companion for `@workspacealberta/wa-acp-snapshot`.
 * @module @workspacealberta/wa-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-acp-snapshot'
