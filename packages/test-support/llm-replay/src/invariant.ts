/**
 * Package-owned invariant companion for `@workspacealberta/wa-llm-replay`.
 * @module @workspacealberta/wa-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-llm-replay'
