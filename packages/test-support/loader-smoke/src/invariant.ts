/**
 * Package-owned invariant companion for `@workspacealberta/wa-loader-smoke`.
 * @module @workspacealberta/wa-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-loader-smoke'
