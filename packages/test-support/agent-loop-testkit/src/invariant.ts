/**
 * Package-owned invariant companion for `@workspacealberta/wa-agent-loop-testkit`.
 * @module @workspacealberta/wa-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-agent-loop-testkit'
