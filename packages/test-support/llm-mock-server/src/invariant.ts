/**
 * Package-owned invariant companion for `@workspacealberta/wa-llm-mock-server`.
 * @module @workspacealberta/wa-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-llm-mock-server'
