/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-subagent-report`.
 * @module @workspacealberta/wa-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-subagent-report'
