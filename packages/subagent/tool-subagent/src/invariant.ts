/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-subagent`.
 * @module @workspacealberta/wa-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-subagent'
