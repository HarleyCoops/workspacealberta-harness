 ...
 * @module @workspacealberta/wa-tool-subagent-control/list-agents
 */
...
import type { SubagentDescendantListEntry, SubagentListEntry } from '@workspacealberta/wa-subagent'
