/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-subagent-control`.
 * @module @workspacealberta/wa-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-subagent-control'
