 ...
 * runtime over stdio JSON-RPC through `@workspacealberta/wa-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@workspacealberta/wa-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @workspacealberta/wa-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@workspacealberta/wa-sdk-client'
import type { ContentBlock } from '@workspacealberta/wa-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@workspacealberta/wa-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@workspacealberta/wa-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@workspacealberta/wa-subagent'
