/**
 * Package-owned invariant companion for `@workspacealberta/wa-subagent-dsh-sdk`.
 * @module @workspacealberta/wa-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-subagent-dsh-sdk'
