 ...
 *
 * @module @workspacealberta/wa-subagent/types
 */

import type { Agent, AgentOptions } from '@workspacealberta/wa-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@workspacealberta/wa-tools'
