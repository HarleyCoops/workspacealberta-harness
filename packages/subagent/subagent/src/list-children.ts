...
import type { SessionProjectionRegistry } from '@workspacealberta/wa-session-projection'
import type { SessionProjectionCache } from '@workspacealberta/wa-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @workspacealberta/wa-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @workspacealberta/wa-session)',
