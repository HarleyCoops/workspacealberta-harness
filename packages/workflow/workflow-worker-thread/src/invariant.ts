/**
 * Package-owned invariant companion for `@workspacealberta/wa-workflow-worker-thread`.
 * @module @workspacealberta/wa-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-workflow-worker-thread'
