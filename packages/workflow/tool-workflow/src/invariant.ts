/** Package-owned durable workflow-record invariants. @module @workspacealberta/wa-tool-workflow/invariant */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-workflow'
