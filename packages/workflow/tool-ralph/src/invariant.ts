/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-ralph`.
 * @module @workspacealberta/wa-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-ralph'
