/** Package-owned invariant companion for `@workspacealberta/wa-attachment`. @module @workspacealberta/wa-attachment/invariant */

/* jscpd:ignore-start */
import type { Context } from '@workspacealberta/cordis'
import type { InvariantInstaller } from '@workspacealberta/wa-invariants'

const PACKAGE_NAME = '@workspacealberta/wa-attachment'
