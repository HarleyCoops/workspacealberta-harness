/**
 * Package-owned invariant companion for `@workspacealberta/wa-sdk-protocol`.
 * @module @workspacealberta/wa-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-sdk-protocol'
