 ...
 * (`@workspacealberta/wa-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@workspacealberta/wa-sdk-client`, the Python SDK) drive it.
 *
 * @module @workspacealberta/wa-sdk-protocol
 */
