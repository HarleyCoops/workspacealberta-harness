 ...
 * plugin (`@workspacealberta/wa-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @workspacealberta/wa-sdk-protocol/types
 */

import type { ContentBlock } from '@workspacealberta/wa-llm'
import type { SessionEvent } from '@workspacealberta/wa-session'
import type { SubagentStopReason } from '@workspacealberta/wa-subagent'
