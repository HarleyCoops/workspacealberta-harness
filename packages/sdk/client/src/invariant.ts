/**
 * Package-owned invariant companion for `@workspacealberta/wa-sdk-client`.
 * @module @workspacealberta/wa-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-sdk-client'
