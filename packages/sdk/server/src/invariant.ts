/**
 * Package-owned invariant companion for `@workspacealberta/wa-sdk-jsonrpc-server`.
 * @module @workspacealberta/wa-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-sdk-jsonrpc-server'
