/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-session-query`.
 * @module @workspacealberta/wa-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-session-query'
