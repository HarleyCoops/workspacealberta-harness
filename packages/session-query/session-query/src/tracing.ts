...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@workspacealberta/wa-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@workspacealberta/wa-session'
