/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-query`.
 * @module @workspacealberta/wa-session-query/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-query'
