/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-query-sqlite`.
 * @module @workspacealberta/wa-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-query-sqlite'
