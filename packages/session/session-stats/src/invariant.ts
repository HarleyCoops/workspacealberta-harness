/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-stats`.
 * @module @workspacealberta/wa-session-stats/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-stats'
