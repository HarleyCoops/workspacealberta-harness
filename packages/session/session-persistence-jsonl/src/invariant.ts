/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-persistence-jsonl`.
 * @module @workspacealberta/wa-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-persistence-jsonl'
