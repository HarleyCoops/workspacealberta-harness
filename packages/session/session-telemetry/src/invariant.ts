/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-telemetry`.
 * @module @workspacealberta/wa-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-telemetry'
