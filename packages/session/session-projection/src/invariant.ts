/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-projection`.
 * @module @workspacealberta/wa-session-projection/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-projection'
