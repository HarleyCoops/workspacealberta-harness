/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-title-all-prompts-llm`.
 * @module @workspacealberta/wa-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-title-all-prompts-llm'
