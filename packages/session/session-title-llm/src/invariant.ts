/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-title-llm`.
 * @module @workspacealberta/wa-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-title-llm'
