/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-telemetry-otel`.
 * @module @workspacealberta/wa-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-telemetry-otel'
