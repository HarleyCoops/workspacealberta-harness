 ...
 *
 * @module @workspacealberta/wa-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@workspacealberta/schemastery'
import type { Context } from '@workspacealberta/cordis'
import type {} from '@workspacealberta/wa-command-feedback'
import {
...
} from '@workspacealberta/wa-session-telemetry'
import { APP_IDENTITY } from '@workspacealberta/wa-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@workspacealberta/wa-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@workspacealberta/wa-session-telemetry-otel/ops', version)
