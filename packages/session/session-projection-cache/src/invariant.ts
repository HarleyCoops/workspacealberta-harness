/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-projection-cache`.
 * @module @workspacealberta/wa-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-projection-cache'
