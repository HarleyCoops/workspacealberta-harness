/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-checkpoint-policy`.
 * @module @workspacealberta/wa-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-checkpoint-policy'
