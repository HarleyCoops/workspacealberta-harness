/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-persistence`.
 * @module @workspacealberta/wa-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-persistence'
