/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-title`.
 * @module @workspacealberta/wa-session-title/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-title'
