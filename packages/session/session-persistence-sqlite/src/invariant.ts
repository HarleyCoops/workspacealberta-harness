/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-persistence-sqlite`.
 * @module @workspacealberta/wa-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-persistence-sqlite'
