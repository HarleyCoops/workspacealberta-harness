/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-title-first-prompt-llm`.
 * @module @workspacealberta/wa-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-title-first-prompt-llm'
