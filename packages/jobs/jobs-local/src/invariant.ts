/**
 * Package-owned invariant companion for `@workspacealberta/wa-jobs-local`.
 * @module @workspacealberta/wa-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-jobs-local'
...
/**
 * No runtime invariant: `@workspacealberta/wa-jobs/invariant` owns per-snapshot identity, status,
