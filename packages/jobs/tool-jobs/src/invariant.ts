/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-jobs`.
 * @module @workspacealberta/wa-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-jobs'
