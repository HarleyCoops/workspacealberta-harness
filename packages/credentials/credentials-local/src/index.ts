 ...
 * @module @workspacealberta/wa-credentials-local
 */
...
import { withFileLock, writeFileAtomic } from '@workspacealberta/wa-atomic-write'
import { canonicalizeWatchPath, resolveDshHome } from '@workspacealberta/wa-home-paths'
import { launchEnvironmentOf } from '@workspacealberta/wa-launch-environment'
import { CredentialProvider, credentialRef } from '@workspacealberta/wa-credentials'
