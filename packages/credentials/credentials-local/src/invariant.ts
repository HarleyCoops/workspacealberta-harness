/**
 * Package-owned invariant companion for `@workspacealberta/wa-credentials-local`.
 * @module @workspacealberta/wa-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-credentials-local'
