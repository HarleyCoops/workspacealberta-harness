/**
 * Package-owned invariant companion for `@workspacealberta/wa-invariants`.
 * @module @workspacealberta/wa-invariants/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-invariants'
