/**
 * Package-owned invariant companion for `@workspacealberta/wa-lsp-stdio`.
 * @module @workspacealberta/wa-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-lsp-stdio'
