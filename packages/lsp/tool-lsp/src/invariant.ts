/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-lsp`.
 * @module @workspacealberta/wa-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-lsp'
