/**
 * Package-owned invariant companion for `@workspacealberta/wa-persona`.
 * @module @workspacealberta/wa-persona/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-persona'
