 ...
 * @module @workspacealberta/wa-agent-presets/mount
 */
...
import type { EntryTree } from '@workspacealberta/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@workspacealberta/wa-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@workspacealberta/wa-*` row would fail to import. The
