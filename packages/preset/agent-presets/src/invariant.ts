/**
 * Package-owned invariant companion for `@workspacealberta/wa-agent-presets`.
 * @module @workspacealberta/wa-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@workspacealberta/wa-agent-presets'

const PACKAGE_NAME = '@workspacealberta/wa-agent-presets'
