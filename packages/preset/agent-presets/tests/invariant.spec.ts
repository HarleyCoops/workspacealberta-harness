...
import AgentRegistry, { assembleContextFor } from '@workspacealberta/wa-agent'
import AgentLoop from '@workspacealberta/wa-agent-loop'
import InvariantRegistry from '@workspacealberta/wa-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@workspacealberta/wa-agent-presets'
import * as AgentPresetsInvariant from '@workspacealberta/wa-agent-presets/invariant'
