/** JSON string-prefix accounting for the outer-output ledger. @module @workspacealberta/wa-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@workspacealberta/wa-code-runtime'
