/**
 * Package-owned invariant companion for `@workspacealberta/wa-code-runtime-worker-thread`.
 * @module @workspacealberta/wa-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-code-runtime-worker-thread'
