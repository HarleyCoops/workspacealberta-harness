/**
 * Package-owned invariant companion for `@workspacealberta/wa-tmux-context`.
 * @module @workspacealberta/wa-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tmux-context'
