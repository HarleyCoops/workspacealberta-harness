/**
 * Package-owned invariant companion for `@workspacealberta/wa-agent-instructions`.
 * @module @workspacealberta/wa-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-agent-instructions'
