/**
 * Package-owned invariant companion for `@workspacealberta/wa-session-reference`.
 * @module @workspacealberta/wa-session-reference/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-session-reference'
