/**
 * Package-owned invariant companion for `@workspacealberta/wa-file-reference`.
 * @module @workspacealberta/wa-file-reference/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-file-reference'
