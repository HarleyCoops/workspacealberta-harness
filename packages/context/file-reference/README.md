# `@workspacealberta/wa-file-reference`
...
Indirectly, through `@workspacealberta/wa-file-reference-local`, which conditionally contributes this package's stable file-reference guidance.
