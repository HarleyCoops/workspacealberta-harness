 ...
 * `@workspacealberta/wa-output-retention` (`TextRetainer`), storage is `ctx.spillStore`.
 ...
 *
 * @module @workspacealberta/wa-spill-policy
 */

import type { Context } from '@workspacealberta/cordis'
import z from '@workspacealberta/schemastery'
import type { ContentBlock } from '@workspacealberta/wa-llm'
import { TextRetainer, describeOmitted } from '@workspacealberta/wa-output-retention'
import type { Omitted } from '@workspacealberta/wa-output-retention'
