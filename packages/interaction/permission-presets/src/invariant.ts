/** Package-owned permission-preset event invariants. @module @workspacealberta/wa-permission-presets/invariant */
...
const PACKAGE_NAME = '@workspacealberta/wa-permission-presets'
