...
import * as CommandInvariant from '@workspacealberta/wa-commands/invariant'
...
import { CommandId } from '@workspacealberta/wa-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@workspacealberta/wa-commands',
    }))
  })
