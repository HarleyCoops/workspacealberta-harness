/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-ask-user`.
 * @module @workspacealberta/wa-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-ask-user'
