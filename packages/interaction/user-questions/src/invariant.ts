/**
 * Package-owned invariant companion for `@workspacealberta/wa-user-questions`.
 * @module @workspacealberta/wa-user-questions/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-user-questions'
