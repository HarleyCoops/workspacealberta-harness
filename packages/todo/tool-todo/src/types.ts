 ...
 *
 * @module @workspacealberta/wa-tool-todo/types
 */

import type { TodoItem } from '@workspacealberta/wa-session/types'

export type { TodoItem } from '@workspacealberta/wa-session/types'
