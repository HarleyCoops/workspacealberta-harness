/** Package-owned goal-round prompt invariants. @module @workspacealberta/wa-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@workspacealberta/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@workspacealberta/wa-goal'
...
const PACKAGE_NAME = '@workspacealberta/wa-goal-round-driver'
