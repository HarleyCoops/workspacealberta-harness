/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-goal`.
 * @module @workspacealberta/wa-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-goal'
