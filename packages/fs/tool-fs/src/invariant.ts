/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-fs`.
 * @module @workspacealberta/wa-tool-fs/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-fs'
