 ...
 * `@workspacealberta/wa-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@workspacealberta/wa-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@workspacealberta/wa-tool-fs`),
 * exactly as bash's does.
 *
 * @module @workspacealberta/wa-fs-sandbox
 */

import { Context } from '@workspacealberta/cordis'
import { LocalFileSystem } from '@workspacealberta/wa-fs-local'
import type { Config as LocalConfig } from '@workspacealberta/wa-fs-local'
import { FsError } from '@workspacealberta/wa-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@workspacealberta/wa-fs'
import { writableRoots } from '@workspacealberta/wa-sandbox'
