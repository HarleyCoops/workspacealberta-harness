/**
 * Package-owned invariant companion for `@workspacealberta/wa-fs-sandbox`.
 * @module @workspacealberta/wa-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-fs-sandbox'
