 ...
 * model-facing render consumes ({@link module:@workspacealberta/wa-tool-fs-search/search-core}
 ...
 *
 * @module @workspacealberta/wa-tool-fs-search/presentation
 */
 ...
 * ({@link module:@workspacealberta/wa-tool-fs-search/grep} `formatGrepMatches`), so
