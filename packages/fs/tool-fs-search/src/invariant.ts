/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-fs-search`.
 * @module @workspacealberta/wa-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-fs-search'
