 ...
 *
 * @module @workspacealberta/wa-tool-fs-search/grep
 */

import type { Context } from '@workspacealberta/cordis'
import { defineTool } from '@workspacealberta/wa-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@workspacealberta/wa-tools'
import type { RetainedItems } from '@workspacealberta/wa-output-retention'
import type { SpillRef } from '@workspacealberta/wa-spill'
