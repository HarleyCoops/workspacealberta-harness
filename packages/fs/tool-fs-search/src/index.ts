 ...
 * ({@link module:@workspacealberta/wa-tool-fs-search/glob} /
 * {@link module:@workspacealberta/wa-tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @workspacealberta/wa-tool-fs-search
 */
