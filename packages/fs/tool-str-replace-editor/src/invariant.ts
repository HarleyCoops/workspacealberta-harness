/**
 * Package-owned invariant companion for `@workspacealberta/wa-tool-str-replace-editor`.
 * @module @workspacealberta/wa-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-tool-str-replace-editor'
