/**
 * Package-owned invariant companion for `@workspacealberta/wa-token-meter`.
 * @module @workspacealberta/wa-token-meter/invariant
 */
...
const PACKAGE_NAME = '@workspacealberta/wa-token-meter'
