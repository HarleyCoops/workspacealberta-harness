...
<p align="center">
  <img src="docs/assets/women-workers-collage.png" alt="八张加拿大女性参与战时工业生产的照片：焊接、机械加工、制图和弹药加工，1940—1945 年。" width="100%">
</p>
...
通过 [本地 APC 连接器](integrations/apc/README.md)，可在 Cohere harness 中连接供应商账户并下载招标文件。
