...
This overlay opts one `wa web` process into Schedule reminders without changing the shipped default Web composition:

```sh
wa web --patch examples/web-schedule/cordis.yml
```
