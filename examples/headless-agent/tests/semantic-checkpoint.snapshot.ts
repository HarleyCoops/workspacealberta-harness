...
import { normalizeSessionLog, scrubRequestHeaders, type NormalizeContext } from '@workspacealberta/wa-acp-snapshot'
...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId, type SessionEvent, type SessionHeader } from '@workspacealberta/wa-session'
