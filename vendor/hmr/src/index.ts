import { Context, Service, type Plugin } from '@workspacealberta/cordis'
import type { Dict } from '@workspacealberta/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@workspacealberta/cordis-plugin-loader'
import type { Include } from '@workspacealberta/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@workspacealberta/cordis-plugin-timer'
