...
import type { SubagentProvider, SubagentReportDelivery } from '@workspacealberta/wa-subagent'
...
import * as ToolSubagentReport from '@workspacealberta/wa-tool-subagent-report'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@workspacealberta/wa-tool-subagent-report',
