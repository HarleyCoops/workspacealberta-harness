...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@workspacealberta/wa-typert-generator'
import type { CordisCatalogPolicy } from '@workspacealberta/wa-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@workspacealberta/cordis'`
 ...
 * scan reads EVERY `declare module '@workspacealberta/cordis'` Events merge under
