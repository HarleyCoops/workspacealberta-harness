...
const CHOOSER_PACKAGE = '@workspacealberta/wa-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@workspacealberta/wa-host-directory-picker-native',
  '@workspacealberta/wa-host-directory-picker-browse',
  '@workspacealberta/wa-client-ui-directory-picker-browse',
  '@workspacealberta/wa-client-ui-directory-picker-native',
]
const errors: string[] = []
...
function validateEntry(value: unknown, file: string, path: string): void {
  ...
  if (value.name !== '@workspacealberta/cordis-plugin-include') return
