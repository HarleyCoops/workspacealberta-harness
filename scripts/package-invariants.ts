...
function checkManifest(
  ...
  if (owner.packageName === '@workspacealberta/wa-invariants') return
  if (manifest.peerDependencies?.['@workspacealberta/wa-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@workspacealberta/wa-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@workspacealberta/wa-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@workspacealberta/wa-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@workspacealberta/wa-invariants'
