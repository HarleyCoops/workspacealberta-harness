...
- id: sdk-jsonrpc-server
  name: '@workspacealberta/wa-sdk-jsonrpc-server'
- id: agent-core
  name: '@workspacealberta/wa-agent-spine-demo'
  config:
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@workspacealberta/wa-code-runtime-worker-thread'
- id: subagents
...
- id: cordis-host-runner
  name: '@workspacealberta/wa-cordis-host-runner'
- id: cordis-tool
  name: '@workspacealberta/wa-tool-cordis'
"""
FS_SEARCH_CORDIS = """\
- id: sdk-jsonrpc-server
  name: '@workspacealberta/wa-sdk-jsonrpc-server'
...
- id: fs-search
  name: '@workspacealberta/wa-tool-fs-search'
  config:
