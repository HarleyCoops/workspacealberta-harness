 ...
 * itself (`wa web`), so any process that rewrites `lib/client.js` files
 ...
 * `lib/client.js`, and `vite build` rewrites `apps/web/dist`, which `wa web`
...
/** Compile-shell workspace whose dist `wa web` serves. */
const SHELL_PACKAGE = '@workspacealberta/wa-web-frontend'
