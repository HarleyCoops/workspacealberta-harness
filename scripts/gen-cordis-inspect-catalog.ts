...
import type { CordisCatalogModel, ServiceMethodEntry } from '@workspacealberta/wa-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@workspacealberta/wa-tool-cordis/api-catalog', '@workspacealberta/wa-cordis-client-runner/client/api-catalog')
